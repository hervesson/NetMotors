                    ...
                    <View style={{ height: 450, backgroundColor: "white", marginTop: 40 }}>
                        ...
                        <View style={{ paddingTop: 30 }}>
                            <Text style={{ color: '#9D9D9D', textAlign: 'center', fontSize: 14 }}>
                                Agora vamos esperar e torcer para que você consiga alcançar seu objetivo de venda.
                            </Text>
                        </View>
                        <View style={{ justifyContent: 'center', alignItems: 'center', paddingTop: 50 }}>
                            <TouchableOpacity
                                ...
                                onPress={() => 
                                    navigation.reset({
                                        index: 0,
                                        routes: [{ name: 'Home' }], // Substitua 'Home' pelo nome da sua tela principal
                                    })
                                }
                            >
...
export default RegistrationAdFinish
